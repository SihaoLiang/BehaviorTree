...
{
    public class XNodeEditor : EditorWindow
    {
        ...
        public static Vector2 Center
        {
            get
            {
                return new Vector2(XNodeEditor.MaxCanvasSize * 0.5f, XNodeEditor.MaxCanvasSize * 0.5f);
            }
        }
        [SerializeField]
        ...
        protected virtual void OnEnable()
        {
            ...
            this.UpdateScrollPosition(XNodeEditor.Center);
        }
        ...
        protected void Begin()
        {
            ...
            {
                XBehaviorTreeEditorStyles.canvasBackground.Draw(scaledCanvasSize, false, false, false, false);
                DrawGrid();
            }
        ...
        private void DrawGrid()
        {
            GL.PushMatrix();
            GL.Begin(1);
            this.DrawGridLines(scaledCanvasSize, XNodeEditor.GridMinorSize, offset, XBehaviorTreeEditorStyles.gridMinorColor);
            this.DrawGridLines(scaledCanvasSize, XNodeEditor.GridMajorSize, offset, XBehaviorTreeEditorStyles.gridMajorColor);
            GL.End();
            GL.PopMatrix();
        }
        ...
        protected void DrawConnection(Vector3 start, Vector3 end, Color color, int arrows, bool offset)
        {
            ...
            Handles.color = color;
            Handles.DrawAAPolyLine(tex, 8.0f, new Vector3[] { start, end });
            ...
            {
                Vector3 center = vector33 + vector31 * 7.0f * i + vector31 * 7.0f - vector31 * arrows * 7.0f;
                DrawArrow(color, cross, vector31, center, 7.0f);
            }
        }
